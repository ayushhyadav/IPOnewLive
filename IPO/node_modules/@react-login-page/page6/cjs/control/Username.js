...
var Username = exports.Username = /*#__PURE__*/(0, _react.memo)(function (props) {
  var _props$keyname = props.keyname,
    keyname = _props$keyname === void 0 ? 'username' : _props$keyname,
    name = props.name,
    rename = props.rename,
    _props$label = props.label,
    label = _props$label === void 0 ? 'Username:' : _props$label,
  ...
  (0, _react.useEffect)(function () {
    return dispatch((0, _defineProperty2["default"])({}, "$".concat(key), label));
  }, [label]);
